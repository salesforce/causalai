...
class BenchmarkTimeSeriesBase:
    '''
    Base class for the time_series data benchmarking module for both continuous and discrete cases. This class defines 
    ...
    def __init__(self, algo_dict:Dict=None, kargs_dict:Dict=None, num_exp:int=20, custom_metric_dict:Dict={}, **kargs):
        '''
        Base time_series data benchmarking module
...
def base_synthetic_time_series_benchmark(algo_dict, kargs_dict, noise_fn, num_vars=20, graph_density=0.1, T=1000, data_max_lag=3, num_exp=20,\
    ...
    for seed in tqdm.tqdm(range(num_exp)):
        sem = GenerateSparseTimeSeriesSEM(var_names=var_names, graph_density=graph_density, seed=seed, fn=fn, coef=coef, max_lag=data_max_lag)
...
class BenchmarkContinuousTimeSeriesBase(BenchmarkTimeSeriesBase):
    '''
    Base class for the time_series data benchmarking module for the continuous case. This class inherits the methods and 
    ...
    def __init__(self, algo_dict:Dict=None, kargs_dict:Dict=None, num_exp:int=20, custom_metric_dict:Optional[Dict]={}, **kargs):
        '''
         Benchmarking module for continuous time_series data.
        ...
        BenchmarkTimeSeriesBase.__init__(self, algo_dict=algo_dict, num_exp=num_exp, kargs_dict=kargs_dict,
...
class BenchmarkDiscreteTimeSeriesBase(BenchmarkTimeSeriesBase):
    '''
    Base class for the time_series data benchmarking module for the discrete case. This class inherits the methods and 
    variables from BenchmarkTimeSeriesBase, and defines 
    the dictionaries of default causal discovery algorithms and their default respective arguments.
    '''
    default_algo_dict = {
    ...
    default_kargs_dict = {
            'PC-Pearson': {'max_condition_set_size': 4, 'pvalue_thres': 0.01, 'max_lag': 3},
            'PC-Log-Likelihood': {'max_condition_set_size': 4, 'pvalue_thres': 0.01, 'max_lag': 3},
            'PC-Mod-Log-Likelihood': {'max_condition_set_size': 4, 'pvalue_thres': 0.01, 'max_lag': 3},
            'PC-Freeman-Tukey': {'max_condition_set_size': 4, 'pvalue_thres': 0.01, 'max_lag': 3},
            'PC-Neyman': {'max_condition_set_size': 4, 'pvalue_thres': 0.01}, 'max_lag': 3}

    def __init__(self, algo_dict:Dict=None, kargs_dict:Dict=None, num_exp:int=20, custom_metric_dict:Optional[Dict]={}, **kargs):
        '''
        Benchmarking module for discrete time_series data.
