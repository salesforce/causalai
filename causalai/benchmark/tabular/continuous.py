'''
This is the benchmarking module for continuous tabular data. This module supports methods that evaluates causal discovery algorithms against various challenges, 
...
from .base import base_synthetic_tabular_benchmark, BenchmarkContinuousTabularBase

class BenchmarkContinuousTabular(BenchmarkContinuousTabularBase):
    '''
    Continuous tabular data benchmarking module. This class inherits the methods and 
    ...
    def __init__(self, algo_dict:Dict=None, kargs_dict:Dict=None, num_exp:int=20, custom_metric_dict:Optional[Dict]={}, **kargs):
        ...
        '''
        BenchmarkContinuousTabularBase.__init__(self, algo_dict=algo_dict, num_exp=num_exp,
    ...
    def benchmark_noise_type(self, noise_fn_types:List[Callable]=[np.random.randn, np.random.rand], 
                            ...
                            num_vars:int=20, graph_density:float=0.1, T:int=1000, fn:Callable = lambda x:x, coef:float=0.1):
        '''
    ...
    def benchmark_snr(self, snr_list:List[float]=[0.01, 0.1, 1.], num_vars:int=20, graph_density:float=0.1, T:int=1000,\
