...
class TestGrangerTimeSeriesModel(unittest.TestCase):
    def test_granger_time_series_model(self):
        ...
        graph_gt = {'A': {'parents': [('A', -1), ('B', -1), ('D', -1)],\
                          'value_dict': {('A', -1): 0.6960504486081752,\
                    ('A', -2): 0.0014181763497011707, ('B', -1): -0.3671415428291086,\
                    ('B', -2): -0.009641970232916474, ('C', -1): -0.0, ('C', -2): 0.0,\
                    ('D', -1): 0.07206176055281632, ('D', -2): 0.0012596247064715557},\
                    'pvalue_dict': {('A', -1): 0.0, ('A', -2): 0.8969213054802957, \
                    ('B', -1): 0.0, ('B', -2): 0.2674455344234633, ('C', -1): 1.0,\
                    ('C', -2): 1.0, ('D', -1): 2.9629987034889116e-145, ('D', -2): 0.7487951985973489},\
                    }, 'B': {'parents': [('B', -1), ('D', -1)],\
                    'value_dict': {('A', -1): -0.0, ('A', -2): -0.010483044174705851,\
                    ('B', -1): 0.801088799913082, ('B', -2): -0.0, ('C', -1): 0.003971211163299437,\
                    ('C', -2): -0.019455828150947867, ('D', -1): 0.3265395990339475,\
                    ('D', -2): 0.008802295547999139}, 'pvalue_dict': {('A', -1): 1.0,\
                    ('A', -2): 0.6485782632746476, ('B', -1): 0.0, ('B', -2): 1.0,\
                    ('C', -1): 0.7790044486215686, ('C', -2): 0.128680515541414,\
                    ('D', -1): 0.0, ('D', -2): 0.2869174022399883}},\
                    'C': {'parents': [('C', -1), ('B', -2), ('D', -1)],\
                    'value_dict': {('A', -1): -0.0, ('A', -2): -0.0, ('B', -1): 0.0,\
                    ('B', -2): 0.438727913930932, ('C', -1): 0.49426405900198583,\
                    ('C', -2): 0.006620230210262223, ('D', -1): 0.21319167123510152,\
                    ('D', -2): 0.0}, 'pvalue_dict': {('A', -1): 1.0, ('A', -2): 1.0, ('B', -1): 1.0,\
                    ('B', -2): 1.417312994127969e-147, ('C', -1): 1.1631811205146225e-289,\
                    ('C', -2): 0.5644908686711262, ('D', -1): 0.0, ('D', -2): 1.0},\
                    }, 'D': {'parents': [('D', -1)],\
                    'value_dict': {('A', -1): 0.0, ('A', -2): -0.0, ('B', -1): -0.0, ('B', -2): -0.0,\
                    ('C', -1): 0.0, ('C', -2): 0.0, ('D', -1): 0.3881938025602495, ('D', -2): 0.0},\
                    'pvalue_dict': {('A', -1): 1.0, ('A', -2): 1.0, ('B', -1): 1.0,\
                    ('B', -2): 1.0, ('C', -1): 1.0, ('C', -2): 1.0, ('D', -1): 5.589775953001244e-154,\
                    ('D', -2): 1.0}}}
